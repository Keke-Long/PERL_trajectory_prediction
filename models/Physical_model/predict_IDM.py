...
arg = (22.018, 0.901, 2.972, 1.697, 1.19) # 500sample标定的结果
...
for chain_id in unique_chain_ids:
    ...
    if all(chain_df_1['a_IDM_2'] >= -3.5) \
            and all(chain_df_1['a_residual_IDM'] > -3.5) \
            and all(chain_df_1['a_residual_IDM'] < 3.5) \
...
# filtered_data_df = pd.read_csv("/home/ubuntu/Documents/PERL/data/NGSIM_haotian/NGSIM_US101_IDM_results1.csv")
