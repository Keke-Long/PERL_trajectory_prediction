...
img_width = 1400
img_height = 1400
img = Image.new('RGB', (img_width*4+80, img_height*3+220), (255, 255, 255))
...
h = 520 + img_height
img.paste(Image.open(f"../results/r{r_num}_500 Convergence Rate.png"), (20, h))
img.paste(Image.open(f"../results/r{r_num}_1000 Convergence Rate.png"), (20+img_width+20, h))
img.paste(Image.open(f"../results/r{r_num}_5000 Convergence Rate.png"), (20+img_width*2+40, h))
img.paste(Image.open(f"../results/r{r_num}_42000 Convergence Rate.png"),(20+img_width*3+60, h))

h = 500 + img_height*2
img.paste(Image.open(f"../results/distribution of variance a and residual1.png"), (130, h))
img.paste(Image.open(f"../results/distribution of a.png"), (2040, h))
img.paste(Image.open(f"../results/distribution of a_residual.png"), (3900, h))
...
img.paste(legend, (260, 290 + img_height))

legend = Image.open('../results/legend convergence2.png')
legend = legend.resize((int(legend.width*1.1), int(legend.height*1.1)))
img.paste(legend, (680, 290 + img_height))
...
h = img_height*2+390
draw.text((50, h), "I", font=font, fill='black')
draw.text((2040, h), "J", font=font, fill='black')
draw.text((3900, h), "K", font=font, fill='black')

font = ImageFont.truetype("arial.ttf", 100)  # 可以更改字体和大小
h = 1610+img_height
draw.text((380, h), "Train data size = 100", font=font, fill='black')
draw.text((380+img_width, h), "Train data size = 500", font=font, fill='black')
draw.text((380+img_width*2+30, h), "Train data size = 1000", font=font, fill='black')
draw.text((380+img_width*3+20, h), "Train data size = 20000", font=font, fill='black')
...
draw.rectangle([10, h+170+img_height, 70+4*img_width, img_height*3+200], outline='silver', width=5)
# 保存合并后的图像
